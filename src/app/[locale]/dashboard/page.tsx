    ...
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      ...
      <section className="mt-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-[#10B981]/10 via-[#0C5F4C]/5 to-transparent rounded-2xl border border-[#10B981]/20 p-8 shadow-xl">
            {!showContactForm ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-[#23272f] border border-[#2d3139] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:border-transparent transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full px-4 py-3 bg-[#23272f] border border-[#2d3139] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:border-transparent transition-all resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={status === "loading"}
                    className="w-full px-6 py-3 bg-[#10B981] hover:bg-[#0C5F4C] text-white text-base font-semibold rounded-lg shadow-lg shadow-[#10B981]/20 hover:shadow-[#10B981]/30 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2"
                  >
                    {status === "loading" ? (
                      <>
