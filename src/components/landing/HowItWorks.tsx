...
import { Building2, ShieldCheck, DollarSign, Palette, CreditCard, Heart } from 'lucide-react';
...
export function HowItWorks() {
  ...
  const galleriesSteps: Step[] = [
    { number: 1, icon: Building2, title: t('galleries.step1.title'), description: t('galleries.step1.description') },
    { number: 2, icon: DollarSign, title: t('galleries.step2.title'), description: t('galleries.step2.description') },
    { number: 3, icon: ShieldCheck, title: t('galleries.step3.title'), description: t('galleries.step3.description') },
  ];

  const collectorsSteps: Step[] = [
    { number: 1, icon: Palette, title: t('collectors.step1.title'), description: t('collectors.step1.description') },
    { number: 2, icon: CreditCard, title: t('collectors.step2.title'), description: t('collectors.step2.description') },
    { number: 3, icon: Heart, title: t('collectors.step3.title'), description: t('collectors.step3.description') },
  ];

  const activeSteps = activeOption === 'galleries' ? galleriesSteps : collectorsSteps;
  ...
  return (
    ...
    >
      <div className="container max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <OptionToggle activeOption={activeOption} onOptionChange={setActiveOption} />
