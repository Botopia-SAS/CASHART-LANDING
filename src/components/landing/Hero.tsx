  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-cyan-100 via-teal-100 to-emerald-100 animate-gradient-shift [color-scheme:light]">
        ...
        <div className="container max-w-7xl mx-auto relative z-10 px-4 sm:px-6 py-20">
            ...
            <div className="space-y-6 lg:pr-8 lg:order-1">
              ...
              <div className="relative pt-4 group animate-scale-in animate-delay-300 animate-fill-both">
                <div
                  ...
                  style={{ background: 'radial-gradient(ellipse at center, rgba(12, 95, 76, 0.4) 0%, transparent 70%)' }}
                />
      ...
      <AuthDialog open={showAuth} onOpenChange={setShowAuth} defaultMode="signup" />
