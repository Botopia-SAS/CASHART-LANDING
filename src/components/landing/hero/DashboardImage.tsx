...
export function DashboardImage({ isHovering, alt }: { isHovering: boolean; alt: string }) {
  ...
  const imageSrc = isHovering
    ? "https://res.cloudinary.com/dzi2p0pqa/image/upload/v1763696019/ofu7wiqsbleydwkrkaiu.png"
    : "https://res.cloudinary.com/dzi2p0pqa/image/upload/v1763693868/6fafd5bf-8cbe-4dc0-972e-f646922fa310.png";
