          ...
          <div className="mx-auto max-w-[1380px] px-4 sm:px-10">
            <div className="flex h-16 sm:h-[78px] items-center justify-between gap-5 rounded-full bg-white/70 border border-white/90 shadow-[0_8px_32px_rgba(0,0,0,0.08)] backdrop-blur-xl px-6 sm:px-10">
              ...
              <div className="hidden lg:flex items-center gap-3 xl:gap-4 flex-shrink-0">
                <LanguageSwitcher />
                <Link href={`/${locale}/gallery-signup?mode=signin`}>
                  <Button className="bg-white border border-[#11a987] text-[#0b2842] text-sm 2xl:text-base font-semibold px-5 2xl:px-6 h-10 2xl:h-11 rounded-full whitespace-nowrap hover:bg-[#11a987]/10 transition">
                    {t("signUpGallerist")}
                  </Button>
                </Link>
              </div>
                ...
                <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                  <SheetTrigger asChild>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-9 w-9 p-0 text-[#0b2842]"
                    >
                  ...
                  <SheetContent
                    side="right"
                    className="w-[300px] sm:w-[400px] bg-white text-[#0b2842] border border-[#e1e6ef] shadow-2xl"
                  >
                    ...
                    <nav className="flex flex-col gap-4 mt-8 px-2">
                      ...
                      <div className="border-t border-[#e1e6ef] pt-4 mt-4 space-y-3">
                        <Link
                          href={`/${locale}/gallery-signup?mode=signin`}
                          onClick={() => setMobileMenuOpen(false)}
                        >
                          <Button className="w-full text-base font-semibold h-11 rounded-full break-words bg-white border border-[#11a987] text-[#0b2842] hover:bg-[#11a987]/10">
                            {t("signUpGallerist")}
                          </Button>
                        </Link>
                      </div>
