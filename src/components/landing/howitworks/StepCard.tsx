...
export function StepCard({ step, isVisible, showTimeline }: StepCardProps) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-3xl border-2 border-[#0C5F4C]/20 bg-white/90 backdrop-blur-sm shadow-2xl shadow-[#0C5F4C]/15 p-6 sm:p-8 transition-all hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(12,95,76,0.25)]">
